...
require (
	...
	github.com/openshift/api v0.0.0-20210216135427-8de5cee96c05
...
replace github.com/openshift/library-go => github.com/marun/library-go v0.0.0-20210319010353-de4aa5e58da3
